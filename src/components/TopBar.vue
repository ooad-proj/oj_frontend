<template>
  <v-app-bar app class=" grey darken-3 white--text">
    ...
    <div class=" tw-flex-row tw-space-x-2">
      <button class=" tw-rounded-md tw-transition-all hover:tw-bg-gray-500 tw-p-2 tw-px-1 sm:tw-px-4" @click="$router.push('/home')">
        <v-icon class=" white--text">mdi-home</v-icon> <span class=" tw-hidden sm:tw-inline">首页</span>
      </button>
      ...
      <button class=" tw-rounded-md tw-transition-all hover:tw-bg-gray-500 tw-p-2 tw-px-1 sm:tw-px-4" @click="$router.push('/contest')">
        <v-icon class=" white--text">mdi-trophy</v-icon> <span class=" tw-hidden sm:tw-inline">竞赛</span>
      </button>
    ...
    <v-spacer></v-spacer>
    <v-divider vertical class=" mx-4 grey darken-2"></v-divider>
    <button class=" tw-rounded-md tw-transition-all hover:tw-bg-gray-500 tw-p-2 tw-px-1 sm:tw-px-4" @click="$emit('userClick')">
      <v-icon class=" white--text">mdi-account-circle</v-icon> <span class=" tw-hidden sm:tw-inline">{{user.name == '' ? '用户' : user.name}}</span>
    </button>
